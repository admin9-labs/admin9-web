export default {
  ...
  'login.form.email.required': 'Admin email is required',
  'login.form.email.invalid': 'Enter a valid email address',
  'login.form.email.placeholder': 'Admin email',
  'login.form.password.maxLength': 'Password cannot exceed 255 characters',
