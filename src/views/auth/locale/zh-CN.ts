export default {
  ...
  'login.form.email.required': '管理员邮箱不能为空',
  'login.form.email.invalid': '请输入有效的邮箱地址',
  'login.form.email.placeholder': '请输入管理员邮箱',
  'login.form.password.maxLength': '密码不能超过 255 个字符',
